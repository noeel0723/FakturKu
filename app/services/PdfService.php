...
<body>
    ...
    <table class='totals' style='width:300px;margin-left:auto'>
        ...
        <tr><td>Tax ({$invoice['tax_rate']}%)</td><td style='text-align:right'>" . format_currency((float)$invoice['tax_amount'], $currency) . "</td></tr>
        <tr><td>Discount</td><td style='text-align:right'>-" . format_currency((float)$invoice['discount_amount'], $currency) . "</td></tr>
        <tr class='total-row'><td>TOTAL</td><td style='text-align:right'>" . format_currency((float)$invoice['total'], $currency) . "</td></tr>
        <tr><td>Paid</td><td style='text-align:right'>" . format_currency((float)$invoice['amount_paid'], $currency) . "</td></tr>
        <tr style='font-weight:bold'><td>Balance</td><td style='text-align:right'>" . format_currency(max(0, (float)$invoice['total'] - (float)$invoice['amount_paid']), $currency) . "</td></tr>
    </table>

    {$exchangeInfo}

    " . ($invoice['notes'] ? "<div style='margin-top:20px'><strong>Notes:</strong><br>" . nl2br(e($invoice['notes'])) . "</div>" : '') . "

    <div class='footer'>
        This document was generated by " . e(APP_NAME) . " on " . format_date(date('Y-m-d')) . "
    </div>
</body>
</html>";
    }
