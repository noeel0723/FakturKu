...
<div class="text-center py-5">
    ...
    <p class="text-muted mb-4">Terima kasih, pembayaran Anda sedang diproses dan akan segera dikonfirmasi.</p>
    <?php if ($invoiceId): ?>
    <a href="<?= APP_URL ?>/invoices/show/<?= (int)$invoiceId ?>" class="btn btn-primary"><i class="bi bi-receipt me-1"></i>Lihat Invoice</a>
    <?php endif; ?>
